...
const SecLoader = () => {
    return (
        <div className="sec-loader-container">
            {/* Inline SCSS injection */}
            <style>{`
        .sec-loader-container {
          ...
          #svg-global {
            ...
            // Target individual particles for the animation effect
            #particles {
              .particle {
                animation: floatParticle 2.5s ease-in-out infinite both;
                transform-origin: center;

                // Stagger particle entry and animations cleanly
            ...
            // Pulse effect for structural vectors
            #node-server, #reflectores, #panel-rigth {
              animation: serverPulse 3s ease-in-out infinite alternate;
            }
          }
        }
        ...
        @keyframes serverPulse {
          0% {
            ...
            filter: drop-shadow(0 0 2px rgba(145, 221, 251, 0.2));
          }
          100% {
            transform: translateY(-4px);
            filter: drop-shadow(0 5px 15px rgba(87, 39, 204, 0.4));
          }
        }
      `}</style>

            {/* React Optimized SVG Core */}
            <svg
                id="svg-global"
            ...
            >
                ...
                <g id="panel-rigth">
                    ...
                    <path
                        fill="#91DDFB"
                        d="M67 94.6603C67 93.3848 67.8954 91.8339 69 91.1962V91.1962C70.1046 90.5584 71 92.3509V92.5129C71 93.7884 70.1046 95.3393 69 95.977V95.977C67.8954 96.6147 67 96.0978 67 94.8223V94.6603Z"
                    ></path>
                    <path
